...
//        Assert.assertEquals(speedResult.first, result!!.first)
//        Assert.assertEquals(speedResult.second, result.second)
//    }
//
//    @Test
...
//
//        // 값 검증
//        Assert.assertEquals(40f, filterInfo["accuracy_filter_max"])
//        Assert.assertEquals(2f, filterInfo["kalman_filter_q"])
//        Assert.assertEquals(25.0, filterInfo["speed_filter_max_ms"])
//    }
//}
