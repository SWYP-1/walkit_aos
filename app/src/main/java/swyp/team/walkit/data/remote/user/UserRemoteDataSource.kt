...
import swyp.team.walkit.data.remote.home.dto.UserPointDto
...
class UserRemoteDataSource @Inject constructor(
     ...
     */
    suspend fun searchUserByNickname(nickname: String): List<swyp.team.walkit.data.remote.user.UserSearchResult> {
