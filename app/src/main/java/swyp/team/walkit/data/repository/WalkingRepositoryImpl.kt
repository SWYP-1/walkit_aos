...
import swyp.team.walkit.domain.service.AccelerometerManager
import swyp.team.walkit.domain.service.ActivityRecognitionManager
import swyp.team.walkit.domain.service.ActivityState
...
class WalkingRepositoryImpl @Inject constructor(
    ...
    private var currentMovementState: swyp.team.walkit.domain.service.MovementState? = null
     ...
     */
    private fun notifyActivityStateChange(activityType: swyp.team.walkit.domain.service.ActivityType, confidence: Int) {
     ...
     * 가속도계 업데이트 처리
     */
    private fun handleAccelerometerUpdate(acceleration: Float, movementState: swyp.team.walkit.domain.service.MovementState) {
