...
data class ResponseCharacterDto(
    ...
    val headImage: swyp.team.walkit.data.remote.walking.dto.ItemImageDto? = null,
    @SerialName("bodyImage")
    val bodyImage: swyp.team.walkit.data.remote.walking.dto.ItemImageDto? = null,
    @SerialName("feetImage")
    val feetImage: swyp.team.walkit.data.remote.walking.dto.ItemImageDto? = null,
